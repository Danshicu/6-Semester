...
class Creation(tk.Toplevel):
    ...
    def __init__(self, parent, graph):
        ...
        name_label = Label(self.creation_frame, text="Name", width=20)
        self.name_text = Entry(self.creation_frame, width=50)
        self.create_button = Button(self.creation_frame, text="Create", width=20)
        ...
        choose_button = Button(self.creation_frame, text="Choose", width=25)
        ...
        self.is_subclass_of_entry = Entry(self.create_class_frame, width=40)
        subclasses_label = Label(self.create_class_frame, text="Subclasses")
        self.subclasses_entry = Entry(self.create_class_frame, width=40)
        ...
        self.subject_entry = Entry(self.create_objprop_frame, width=40)
        who_is_object_label = Label(self.create_objprop_frame, text="Object")
        self.object_entry = Entry(self.create_objprop_frame, width=40)
        ...
        self.parent_entry = Entry(self.create_individual_frame, width=40)
