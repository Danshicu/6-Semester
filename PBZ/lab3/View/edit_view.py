...
from Models.ontoClass import OClass
...
class Edit(tk.Toplevel):
    ...
    def __init__(self, parent, graph):
        ...
        class_hints = App_view.App.hint_class
        name_label = Label(self.edit_frame, text="Name", width=20)
        # self.name_text = Entry(self.edit_frame, width=30)
        self.name_text = ttk.Combobox(self.edit_frame, values=class_hints, width=35)
        self.edit_button = Button(self.edit_frame, text="Edit", width=25)
        ...
        choose_button = Button(self.edit_frame, text="Choose", width=25)
        ...
        self.class_name_change_entry = Entry(self.edit_class_frame, width=40)
        parent_change_label = Label(self.edit_class_frame, text="Parent of:")
        self.parent_change_entry = ttk.Combobox(self.edit_class_frame, values=class_hints, width=40)
        ...
        subject_hints = App_view.App.hint_subject
        object_hints = App_view.App.hint_object
        self.edit_objprop_frame = Frame(self.edit_frame, bd=2)
        change_objprop_name_label = Label(self.edit_objprop_frame, text="New name")
        self.change_objprop_name_entry = Entry(self.edit_objprop_frame, width=40)
        new_subject_label = Label(self.edit_objprop_frame, text="New subject")
        self.new_subject_entry = Entry(self.edit_objprop_frame, width=40)
        new_object_label = Label(self.edit_objprop_frame, text="New object")
        self.new_object_entry = Entry(self.edit_objprop_frame, width=40)
        who_is_subject_label = Label(self.edit_objprop_frame, text="Subject")
        self.subject_entry = ttk.Combobox(self.edit_objprop_frame, values=subject_hints, width=40)
        who_is_object_label = Label(self.edit_objprop_frame, text="Object")
        self.object_entry = ttk.Combobox(self.edit_objprop_frame, values=object_hints, width=40)
        ...
        hint_individuals = App_view.App.individuals_dictionary
        self.edit_individual_frame = Frame(self.edit_frame, bd=2)
        change_ind_name = Label(self.edit_individual_frame, text="New name")
        self.change_ind_name_entry = Entry(self.edit_individual_frame, width=40)
        parent_class_label = Label(self.edit_individual_frame, text="Parent")
        self.parent_entry = ttk.Combobox(self.edit_individual_frame, values=hint_individuals, width=40)
