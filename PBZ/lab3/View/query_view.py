...
class Query(tkinter.Toplevel):
    ...
    def __init__(self, parent, graph):
        ...
        self.ontology = graph
        input_frame = Frame(self, bd=5, bg='#660066', pady=6, padx=6)
        self.query_text = Text(input_frame, height=30, width=90, wrap=WORD)
        query_button = Button(input_frame, text="Query", width=40, height=3)
